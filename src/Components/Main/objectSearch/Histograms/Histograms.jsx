...
function Histograms () {
    ...
    // СТЕЙТ: max смещение слайлера, ширина экрана
    // const [maxOffset, setMaxOffset] = React.useState(0);
    // СТЕЙТ: количество видимых столбцов в слайдере
    // const [numVC, setNumVC] = React.useState(0);
    // СТЕЙТ: ширина видимых столбцов в слайдере
    // const [widthVC, setWidthVC] = React.useState(0);
    // СТЕЙТ: ширина экрана
    ...
    return (
        <section className='objectSarch_section2'>
            ...
            <p className='found'>Найдено {totalVar} {getWord(totalVar)}</p>
