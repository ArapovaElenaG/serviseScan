...
// цвета скопированные из App.scss
// Как их можно инпортировать из App.scss ?????????????
...
function Tarrifs ({getOffsetY}) {
    return (
        <div className={`hom_sec3_tariffs ${getOffsetY ? 'tariffsPage' : ''}`}>
            <TariffItem tarif={tariffPlans.beginner} getOffsetY={getOffsetY}/>
            <TariffItem tarif={tariffPlans.pro} getOffsetY={getOffsetY}/>
            <TariffItem tarif={tariffPlans.business} getOffsetY={getOffsetY}/>
        </div>
    )
}
